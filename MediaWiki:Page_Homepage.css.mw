...
.section-press .col-container > div span:not(.image-wrapper):before {
	content: '"';
	font-size: 48px;
	line-height: 34px;
	height: 22px;
...
.mw-collapsible .mw-collapsible-toggle.mw-collapsible-toggle-expanded + h4
{
	display: none;
}
...
.dark-section .mw-collapsible > h4 {
	color: white !important;
...
/* 1.6. NoScript design correction */

#mw-content-text .__ns__pop2top {
...
.section-banner h2.learn-more {
	margin: 25px 0 !important
}

.section-banner .overview-image-and-video-player {
	width: 100%;
	padding-top: 56.25%;
	position: relative;
}

.section-banner #hide-overview-image,
.section-banner .overview-image,
.section-banner .overview-image-and-video-player video,
.section-banner .overview-image-and-video-player a.__NoScript_PlaceHolder__ {
...
.section-banner .overview-image-and-video-player #hide-overview-image {
	height: 100%;
	cursor: pointer;
	z-index: 10;
	opacity: 0;
...
.section-banner .overview-image-and-video-player #hide-overview-image:checked,
.section-banner .overview-image-and-video-player #hide-overview-image:checked + .overview-image {
	display: none;
}
...
.section-banner .overview-image-and-video-player #hide-overview-image:hover + .overview-image {
	transform: scale(1.01);
}

.section-banner .overview-image:after {
	background-image: url(/w/images/thumb/6/62/Play-symbol.png/180px-Play-symbol.png);
	background-position: center;
	background-size: 28%;
	content: ' ';
	display: block;
...
.section-banner .overview-image-and-video-player #hide-overview-image:hover + .overview-image:after {
	opacity: .9;	
}
...
html.client-js .section-banner .overview-image-and-video-player video {
	display: none;
}
...
.section-download > .inner-wrapper > h2 {
	margin-bottom: 27px !important;
}

.section-download > .inner-wrapper > p {
...
.section-competition table td.empty {
	opacity: 0;
}

.section-competition table td.cat {
	font-size: 15px !important;
	position: relative;
}

.section-competition table tr:not(.show-more) td.cat {
	padding-left: 62px;
}

.section-competition table tr.show-more td.cat {
	padding-left: 10px;
}

.section-competition table td.cat i {
	width: 42px;
	height: 42px;
	border-radius: 50px;
	background: #f6f3f4;
...
.section-competition table td.whonix, .section-competition table td.vpn {
	text-align: center;
}

.section-competition table td.whonix {
	background: #f7f7ff;
	border-color: transparent #007bff;
}

.section-competition table td.whonix.top {
	border-top-color: #007bff;
	font-weight: bold;
	border-radius: 10px 10px 0 0;
}

.section-competition table td.whonix.bottom {
	padding: 3px 4px;
...
.section-competition table td.whonix.bottom a {
	font-weight: bold;
	font-size: 19px !important;
	display: block;
	text-decoration: none;
...
.section-competition table td.whonix.bottom a:hover {
	background: #3d64b3;
}

.section-competition table td.vpn.top {
	border-radius: 10px 10px 0 0;
}
.section-competition table td.vpn.bottom {
	border-bottom-right-radius: 10px;
}

.section-competition table td.cat.top {
	border-top-left-radius: 10px;
}
.section-competition table td.cat.bottom {
	border-bottom-left-radius: 10px;
}

.section-competition table td img {
	position: relative;
	top: -2px;
}

.section-competition .info-tooltip {
	position: relative;
	top: 5px;
	margin-left: 4px;
	height: 40px;
...
.section-competition .info-tooltip span {
	max-width: 283px;
	font-weight: normal;
    padding: 10px 15px;
    top: 38px;
...
.section-competition .info-tooltip span, .section-competition .info-tooltip a {
    font-size: 15px !important;
}

.section-competition .show-more {
	display: table-row;
	cursor: pointer;
}

.section-competition .show-more .cat {
	color: #608de7;
}

.section-competition .show-more:hover .cat {
	color: #0645ad;
}

.section-competition .learn-more-vpns {
    background: #f7f7f7;
    text-align: center;
...
.section-competition .learn-more-vpns a {
    font-size: 19px !important;
    margin-left: 7px;
}
...
@media (max-width: 460px) {
	...
	.section-press .inner-wrapper > h2 {
		margin-bottom: 0 !important;
	}
}

@media (max-width: 400px) {
	.section-press .inner-wrapper > div {
...
.section-explain .inner-wrapper > * {
	max-width: 800px;
	margin-left: auto !important;
	margin-right: auto !important;
}

.section-explain .illustration {
	background: #f6f3f4;
	border-radius: 30px;
	padding: 10px 10px 0;
	margin: auto;
...
.section-explain .illustration:hover {
	transform: scale(1.05);
}

.section-explain .illustration img {
	width: 100%;
	height: auto;
}
...
.section-explain p, .section-explain p a {
	font-size: 20px !important;
}
...
.section-upcoming a > span {
	color: white;
	margin-top: 15px;
	display: block;
}

.section-upcoming .enforce-kernel {
	background-color: #142132;
}

.section-upcoming .virus-forge {
	background-color: #142132;
}
...
.section-investor a.image-link img {
	transition: transform .3s;
	width: 100%;
	max-width: 750px;
}

.section-investor a.image-link img:hover {
	transform: scale(1.05);
}
...
@media (max-width: 500px) {
	.section-download, .section-upcoming {
		padding-left: 20px;
		padding-right: 20px;
	}
	.section-download .os {
